...
allteria.edge_navigator = function edge_navigator(world, camera)
{
    allteria.ui_component.call(this, world);
...
allteria.extend(allteria.edge_navigator, allteria.ui_component);

allteria.edge_navigator.prototype.on_mouse_down = function on_mouse_down(event)
{
...
allteria.edge_navigator.prototype.on_mouse_enter = function on_mouse_enter(event)
{
...
allteria.edge_navigator.prototype.on_mouse_leave = function on_mouse_enter(event)
{
    document.body.style.cursor = "default";
    this.hide_all();
}

allteria.edge_navigator.prototype.on_mouse_out = function on_mouse_out(event)
{
    this.hide_all();
}

allteria.edge_navigator.prototype.on_window_resize = function resize(event)
{
    this.position_controls();
}
...
allteria.edge_navigator.prototype.position_controls = function position_controls()
{
...
allteria.edge_navigator.prototype.hide_all = function hide_all()
{
    this.show_right(false);
    this.show_left(false);
    this.show_top(false);
...
allteria.edge_navigator.prototype.show_right = function show_right(visible)
{
    this.right.visible = visible;
    this.right_arrow.visible = visible;
}

allteria.edge_navigator.prototype.show_left = function show_left(visible)
{
    this.left.visible = visible;
    this.left_arrow.visible = visible;
}

allteria.edge_navigator.prototype.show_top = function show_top(visible)
{
    this.top.visible = visible;
    this.up_arrow.visible = visible;
}

allteria.edge_navigator.prototype.show_bottom = function show_bottom(visible)
{
