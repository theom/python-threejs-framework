...
alheimr.tests = function tests(world, scene, hud_scene)
{
    this.world = world;
    this.scene = scene;
...
alheimr.tests.prototype.add_letter = function add_letter(letter, pos, scale)
{
    scale = scale || 4.5;
    var spacing = 0.8;
    letter = new alheimr.letter(letter);
...
alheimr.tests.prototype.test_letters = function test_letters()
{
...
alheimr.tests.prototype.test_text_lines = function test_text_lines()
{
    var line_pos = 450;
    var s;

    s = new alheimr.text_line("Individual text lines:");
    s.translateX(-940);
    s.translateY(line_pos);
    this.scene.add(s);

    s = new alheimr.text_line("ABCDÐEÉFGHIÍJKLMNOÓPQRSTUÚVXYÝZÞÆÖ");
    line_pos -= s.get_height();
    s.translateX(-940);
    s.translateY(line_pos);
    this.scene.add(s);

    s = new alheimr.text_line("aábcdðeéfghiíjklmnoópqrstuúvxyýzþæö1234567890:,.?+-*/!'()@=<>")
    line_pos -= s.get_height();
    s.translateX(-940);
    s.translateY(line_pos);
    this.scene.add(s);

    s = new alheimr.text_line("This is a text line.")
    line_pos -= s.get_height();
    s.translateX(-940);
    s.translateY(line_pos);
    this.scene.add(s);
...
alheimr.tests.prototype.test_editable_text_lines = function test_editable_text_lines()
{
    var s;
    
    s = new alheimr.text_line("This text is editable. 0123456789", 2.5);
    s.set_editable(true);
    s.translateX(-940);
    s.translateY(350);
    this.scene.add(s);
...
alheimr.tests.prototype.test_paragraphs = function test_paragraphs()
{
    var t = "";
    ...
    var p;
    p = new alheimr.paragraph(t, 100);
    p.translateX(-940);
    p.translateY(300);
    this.scene.add(p);
}

alheimr.tests.prototype.test_buttons = function test_buttons()
{
    var b;
    
    b = new alheimr.button("Click here 1");
    ...
    b = new alheimr.button("Click here 2");
    b.on_click = function(event)
    {
    ...
    b = new alheimr.button("Click here 3");
    b.on_click = function(event)
    {
    ...
    b = new alheimr.button("Click here 4");
    b.on_click = function(event)
    {
...
alheimr.tests.prototype.test_checkboxes = function test_checkboxes()
{
    var cb;

    cb = new alheimr.checkbox("Option 1");
    cb.set_scale(4);
    ...
    cb = new alheimr.checkbox("Longer label on this checkbox");
    cb.set_scale(4);
    cb.on_checked = function(event)
    {
    ...
    cb = new alheimr.checkbox("Editable label");
    cb.set_scale(4);
    cb.on_checked = function(event)
    {
...
alheimr.tests.prototype.test_radio_buttons = function test_radio_buttons()
{
    var rb1 = new alheimr.radio_button("Radio button 1");
    rb1.set_scale(3);
    ...
    var rb2 = new alheimr.radio_button("Radio button 2");
    rb2.set_scale(3);
    ...
    var b = new alheimr.button("Reset radio buttons");
    b.on_click = function(event)
    {
        rb1.uncheck();
        rb2.uncheck();
...
alheimr.tests.prototype.test_radio_button_groups = function test_radio_button_groups()
{
    var rg = new alheimr.radio_button_group();
    rg.translateX(-720);
    rg.translateY(-10);
    
    var rb;

    rb = new alheimr.radio_button("Radio button 1 in group");
    rb.set_scale(2);
    ...
    rb = new alheimr.radio_button("Radio button 2 in group");
    rb.set_scale(2);
    rb.on_checked = function(event)
    {
    ...
    rb = new alheimr.radio_button("Radio button 3 in group");
    rb.set_scale(2);
    rb.on_checked = function(event)
    {
...
alheimr.tests.prototype.test_frames = function test_frames()
{
    var f;
    ...
    var t = new alheimr.text_line("A text line within a frame.");
    t.translateX(-360);
    f.add(t);

    var b = new alheimr.button("Button");
    b.translateY(-190);
    b.translateX(320);
    f.add(b);
    
    var c = new alheimr.checkbox("A checkbox within a frame");
    c.translateX(100);
    c.translateY(-80);
    f.add(c);
    ...
    var b = new alheimr.button("Show/hide frame");
    b.translateY(270);
    b.translateX(-130);
    var vis = false;
    b.on_click = function(event)
...
alheimr.tests.prototype.test_zoom = function test_zoom(camera)
{
    var b = new alheimr.button("Zoom in/out");
    b.translateY(-30);
    b.translateX(-400);
    var dir = 1;
    b.on_click = function(event)
...
alheimr.tests.prototype.test_hud = function test_hud()
{
    this.hud_text = new alheimr.text_line("Alheimr HUD");
...
alheimr.tests.prototype.hud_resize = function hud_resize(event)
{
    this.position_hud_text();
}

alheimr.tests.prototype.position_hud_text = function position_hud_text()
{
...
alheimr.tests.prototype.test_edge_navigator = function test_edge_navigator(camera)
{
    var n = new alheimr.edge_navigator(this.world, camera);
